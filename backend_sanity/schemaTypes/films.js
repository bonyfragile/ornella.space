export default {
    ...
    fields: [
        ...
        },
        {
            ...
            type: 'string',
            description: 'Film genre and year. This information will appear in the homepage under the title. Use all small caps.',
        },
        {
            name: 'extendedsubtitle', 
            title: 'Subtitle for Project Card', 
            type: 'string',
            description: 'Film genre, duration, country, year and/or other. This information will appear in the project card.'
        },
        {
            name: 'visibleLinkName', 
            title: 'Visible Link Name', 
            type: 'string',
            initialValue: 'Watch here',
